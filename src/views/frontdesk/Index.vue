                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-4">
                        <div class="product product1">
                            <router-link to="/products" class="product1-img img-fluid">
                            </router-link>
                    ...
                    <div class="col-md-4">
                        <div class="product product2">
                            <router-link to="/products" class="product2-img img-fluid">
                            </router-link>
                            <router-link to="/products" class="text-coffee2 link-product">
                    ...
                    <div class="col-md-4">
                        <div class="product product3">
                            <router-link to="/products" class="product3-img img-fluid">
                            </router-link>
                            <router-link to="/products" class="text-coffee2 link-product">
